                    ...
                    {resources.map((item, idx) => (
                        ...
                        >
                            ...
                            <div className={styles.cardFooter}>
                                <span className={styles.footerText}>{item.comingSoon ? 'In development' : (item.action || 'View Details')}</span>
                                <span className="material-symbols-outlined" style={{ color: 'var(--secondary-color)' }}>arrow_forward</span>
                            </div>
                        </Link>
                    ))}
                </div>
